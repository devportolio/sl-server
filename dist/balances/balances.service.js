...
let BalancesService = class BalancesService extends base_service_1.BaseService {
    constructor(balancesRepository) {
...
BalancesService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(balances_entity_1.Balances)),
