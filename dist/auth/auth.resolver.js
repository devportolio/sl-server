...
let AuthResolver = class AuthResolver {
    ...
    userLogin(credential) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.authService.login(credential);
        });
    }
    userLogout(refreshToken) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.refreshTokenService.deleteToken(refreshToken);
        });
    }
    refreshToken(refreshToken) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.authService.getRefreshToken(refreshToken);
        });
    }
};
__decorate([
    graphql_1.Mutation(),
    __param(0, graphql_1.Args('credential')),
